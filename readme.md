...
- **[Frontend Documentation](frontend/README.md)** - Complete guide for frontend setup, API integration, and deployment
- **[Backend Documentation](backend/README.md)** - API endpoints, database models, authentication, and deployment

---

**FingerPay — Redefining the future of Nigerian Fintech through the power of Biometrics and AI.**  
© 2025 Edu Matrix Team
